...
When starting a new project, create a note with:
...
## Retro
<!-- After shipping: what worked, what patterns go back into Foundations -->
```
...
- **Practices:** Frontend polish, deployment, performance optimization
- **Stack:** Next.js + Vercel + MDX for content
